...
python -m wallee.packs.prusa_core_one_plus.hardware_smoke build-notebook "Benchy Rules.bgcode"
```
...
```bash
python -m wallee.packs.prusa_core_one_plus.hardware_smoke start "Benchy Rules.bgcode"
...
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
python -m wallee.packs.prusa_core_one_plus.hardware_smoke trim-flow
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
python -m wallee.packs.prusa_core_one_plus.hardware_smoke trim-nozzle-up
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
python -m wallee.packs.prusa_core_one_plus.hardware_smoke trim-nozzle-down
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
python -m wallee.packs.prusa_core_one_plus.hardware_smoke trim-bed-up
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
python -m wallee.packs.prusa_core_one_plus.hardware_smoke trim-bed-down
python -m wallee.packs.prusa_core_one_plus.hardware_smoke status
```
...
```bash
python -m wallee.packs.prusa_core_one_plus.hardware_smoke phase1-speed-once
```
...
```bash
python -m wallee.packs.prusa_core_one_plus.hardware_smoke phase1-speed-flow-session
python -m wallee.packs.prusa_core_one_plus.hardware_smoke phase1-speed-nozzle-session
python -m wallee.packs.prusa_core_one_plus.hardware_smoke phase1-speed-bed-session
python -m wallee.packs.prusa_core_one_plus.hardware_smoke phase1-all-families-session
```
...
- `docs/evidence/prusa_core_one_plus/phase1/runs/2026-04-13T125852-phase1-speed-flow-session.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/phase1/runs/2026-04-13T125957-phase1-speed-nozzle-session.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/phase1/runs/2026-04-13T130055-phase1-speed-bed-session.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/phase1/runs/2026-04-13T130243-phase1-all-families-session.json` (evidence artifact — not yet committed to this repository)

Planner-hardening eval artifacts:

- `docs/evidence/prusa_core_one_plus/planner_eval/planner-baseline.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/planner_eval/comparison-report.md` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/planner_eval/cases` (evidence artifact — not yet committed to this repository)
...
```bash
python -m wallee.main --once --goal "Reduce print speed a little while keeping the current print running."
```

Current normal-runtime evidence:

- `docs/evidence/prusa_core_one_plus/live_runtime/README.md` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/RUNBOOK.md` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/runs/2026-04-13T092859-runtime-weak-evidence-no-action.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/runs/2026-04-13T093016-runtime-single-family-speed.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/runs/2026-04-13T093051-runtime-repeat-speed-after-effect.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/runs/2026-04-13T093136-runtime-mixed-family-speed-flow.json` (evidence artifact — not yet committed to this repository)
- `docs/evidence/prusa_core_one_plus/live_runtime/runs/2026-04-13T093445-runtime-mixed-family-flow-nozzle.json` (evidence artifact — not yet committed to this repository)
