...
_MANAGED_FAMILY_ORDER: tuple[_ManagedFamilySpec, ...] = (
    _ManagedFamilySpec(
        ...
        trim_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-speed",
        ...
        reset_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-reset-speed",
    ...
    _ManagedFamilySpec(
        ...
        trim_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-nozzle-up",
        ...
        reset_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-nozzle-down",
        reset_source="operator_only",
    ),
    _ManagedFamilySpec(
        family="flow",
        ...
        trim_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-flow",
        trim_source="operator_only",
        ...
        reset_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-reset-flow",
        reset_source="operator_only",
    ...
    _ManagedFamilySpec(
        ...
        trim_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-bed-up",
        trim_source="operator_only",
        ...
        reset_command="python -m wallee.packs.prusa_core_one_plus.hardware_smoke managed-trim-bed-down",
        reset_source="operator_only",
    ),
)
...
def _active_runtime_holds_serial() -> bool:
    ...
    for line in result.stdout.splitlines():
        ...
        try:
            ...
            pass
        if "python -m wallee.main" in cmd:
            return True
    return False
    ...
    *,
    ...
    return {
        ...
        "commands": {
            ...
            "status": "python -m wallee.packs.prusa_core_one_plus.hardware_smoke status",
        },
        "pre_status": pre,
        "managed_trim": trim,
        "post_reads": post_reads,
    ...
    try:
        ...
        if not initial_status.get("job_active"):
            ...
            payload["cli_commands"].append(
                f"python -m wallee.packs.prusa_core_one_plus.hardware_smoke start {json.dumps(benchy_file)}"
            )
            payload["start_result"] = driver.start_print(benchy_file)
            started_print = True
