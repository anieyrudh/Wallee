...
- `wallee/models.py` - core data contracts
- `wallee/predicates.py` - deterministic predicate evaluation
- `wallee/runtime_db.py` - only durable runtime truth
- `wallee/planning_context.py` - world packet + frontier compilation
- `wallee/planner.py` - planner adapters (heuristic + OpenRouter)
- `wallee/engine.py` - approval, execute, verify, replan
- `wallee/packs/` - hardware-specific implementations
- `wallee/safety.py` - heartbeat and interlock logic
