...
> **Retired document.** This describes the v5 architecture line, now archived on the `legacy/v5` branch (see [`docs/internal/RETIRED_FINDINGS.md`](../internal/RETIRED_FINDINGS.md)). The current v6 architecture entry points are [`AGENTS.md`](../../AGENTS.md) and [`docs/internal/V6_TREE_README.md`](../internal/V6_TREE_README.md); a consolidated v6 architecture document is being written.
