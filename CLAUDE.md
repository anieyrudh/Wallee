...
```bash
# === SSH (for Claude Code on laptop → Pi) ===
...
**Tasks (second Claude Code instance or subagent):**
...
## 18. Development setup for Claude Code
...
# Claude Code will SSH into Pi to develop and test
# Ensure SSH key is set up: ssh-copy-id PI_USER@PI_HOST
```

### 18.2 On the Pi (Claude Code does this via SSH)
